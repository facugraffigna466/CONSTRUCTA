...
Como respaldo transversal a varios de estos objetivos, la suite automatizada del backend alcanza 521 tests distribuidos en 46 archivos (ejecutados en integración continua), que cubren aislamiento por tenant, autenticación, rate limiting e importaciones, sumados a 25 pruebas de frontend sobre la lógica de alertas; no existen todavía pruebas de extremo a extremo (véase Pruebas).
