...
> **Estado de la cobertura automatizada.** El backend cuenta con 521 tests automatizados (*pytest*, 46 archivos) y el frontend con 25 (*Vitest*, 3 archivos), todos corriendo en integración continua. La cobertura de frontend es deliberadamente parcial: se concentra en la lógica de alertas, que fue donde se concentraron los defectos detectados, y no alcanza todavía al resto de la interfaz. No existen pruebas de extremo a extremo (*Playwright*); se deja declarada esa brecha como parte de los objetivos pendientes del proyecto.
