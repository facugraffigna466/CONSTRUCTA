...
| 8 | Panel de indicadores | Implementado | Panel de obra con trece indicadores servidos en una sola llamada: avance real ponderado por duración, avance planificado, índice de desempeño del cronograma (SPI), fecha de fin proyectada, salud de la ruta crítica, desvío contra la línea base, estado de hitos, ejecución de materiales, alertas por severidad, cuello de botella, y una curva de evolución planificado/real historizada día a día por un job del planificador. Cada bloque declara si el dato está disponible y por qué no lo está, en vez de completar con ceros. Diseño documentado en `docs/features/dashboard-indicadores-obra.md` (09/09/2026) e implementación en tres etapas incrementales cerrada el 10/09/2026. | El toggle semana/mes de la curva de avance quedó acotado a semanal; el detalle por responsable de la concentración de retrasos se restringe a administradores por diseño, no por limitación técnica. |
