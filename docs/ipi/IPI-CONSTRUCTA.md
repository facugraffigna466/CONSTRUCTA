...
> **Estado de la cobertura automatizada.** El backend cuenta con 503 tests automatizados (*pytest*, 46 archivos) corriendo en integración continua. No existen todavía pruebas automatizadas de frontend (*Vitest* u otro) ni de extremo a extremo (*Playwright*); se deja declarada esta brecha como parte de los objetivos pendientes del proyecto.
