...
Como respaldo transversal a varios de estos objetivos, la suite automatizada del backend alcanza 603 tests distribuidos en 54 archivos (ejecutados en integración continua), que cubren aislamiento por tenant, autenticación, rate limiting e importaciones, sumados a 49 pruebas de frontend sobre la lógica de alertas; no existen todavía pruebas de extremo a extremo (véase Pruebas).
